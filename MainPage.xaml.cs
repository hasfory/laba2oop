...
namespace laba2oop
{
    public partial class MainPage : ContentPage
    {
        ...
        List<MauiProgram.Publication> results;
        private void PerformSearch(MauiProgram.Publication publication, MauiProgram.IStrategy analyzer)
        {
            ...
            results = search.SearchAlgorithm();
        ...
        private XslCompiledTransform LoadXSLT()
        {
            ...
            try
            {
                xct.Load("C:\\Users\\vivib\\source\\repos\\laba2oop\\Transform.xslt");
            }
            catch { }
        ...
        private void TransformXMLToHTML(XslCompiledTransform xct, XsltArgumentList xslArgs, string xmlPath, string htmlPath)
        {
            ...
            // Генеруємо HTML для кожного об'єкта
            string htmlRows = "";
            ...
            // Вставляємо рядки у HTML-шаблон
            string html = $@"
<!DOCTYPE html>
<html lang='en'>
<head>
...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            string filePath = "C:\\Users\\vivib\\source\\repos\\laba2oop\\PublicationsList.html";
        ...
        {
            var result = await Application.Current.MainPage.DisplayAlert("Exit", "Are you sure you want to exit?", "Yes", "No");
            if (result)
            {
